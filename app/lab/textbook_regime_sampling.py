...
[출력] app/lab/outputs/textbook_regime_sampling/ 에 png 2장 + md 리포트.
실행: .venv/Scripts/python.exe -m app.lab.textbook_regime_sampling
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "outputs", "textbook_regime_sampling")
...
def _prepare():
    ...
    real_d = _dist(collections.Counter(l for l in labels if isinstance(l, str)))

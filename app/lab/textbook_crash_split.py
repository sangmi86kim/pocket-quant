...
[출력] app/lab/outputs/textbook_crash_split/ 에 png 1장 + md 리포트.
실행: .venv/Scripts/python.exe -m app.lab.textbook_crash_split
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "outputs", "textbook_crash_split")

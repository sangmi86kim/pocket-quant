...
[출력] 콘솔 + app/lab/reports/v2_signal_analysis.{md,png}(신호×아레나 상관 히트맵).
실행: .venv/Scripts/python.exe -m app.lab.v2_signal_analysis
"""
...
def _write_md(n, prof, corr, grp, base) -> None:
    ...
    md.append(
        ...
        "\n재현: `.venv/Scripts/python.exe -m app.lab.v2_signal_analysis`\n"
    )

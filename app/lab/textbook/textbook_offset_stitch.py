...
[출력] app/lab/outputs/textbook/textbook_offset_stitch/ 에 png 2장 + md 리포트.
실행: .venv/Scripts/python.exe -m app.lab.textbook.textbook_offset_stitch
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "outputs", "textbook", "textbook_offset_stitch")
...
def _write_md(jump, vmin, vmax, fear, us10y, real_band):
    ...
    L.append(
        ...
        "\n재현: `.venv/Scripts/python.exe -m app.lab.textbook.textbook_offset_stitch`\n"
    )

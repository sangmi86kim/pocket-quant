...
실행: .venv/Scripts/python.exe -m app.lab.textbook.rs_hybrid_textbook
"""
import collections
import os
...
N_WORLDS = 30
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "outputs", "textbook", "rs_hybrid_textbook")
...
def _write_md(real_d, old_d, new_d, dist_to_real, maxmove,
    ...
    L.append(
        ...
        "\n재현: `.venv/Scripts/python.exe -m app.lab.textbook.rs_hybrid_textbook`\n"
    )

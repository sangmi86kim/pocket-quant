...
[출력] 콘솔 표 + reports/시즌3/qqq_regime_distribution.{md,png} (matplotlib 누적 막대).

실행: .venv/Scripts/python.exe -m app.lab.regime_distribution
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "reports")   # app/lab/reports/
...
def main() -> None:
    ...
    md.append(
        ...
        "\n---\n\n재현: `.venv/Scripts/python.exe -m app.lab.regime_distribution`\n"
    )

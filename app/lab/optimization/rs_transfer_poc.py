...
실행: .venv/Scripts/python.exe -m app.lab.optimization.rs_transfer_poc
"""
import os
...
from app.lab.textbook.rs_hybrid_textbook import STATES, make_world_rs
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "..", "outputs", "optimization", "rs_transfer_poc")

...
- oos:     victory_road 빅토리 로드 (OOS) 11개 연도   (챔피언이 실제 선발된 관문)
  - exam:    공식 6체육관
  - holdout: 사천왕 hold-out 7개 라운드

실행: .venv/Scripts/python.exe -m app.lab.optimization.median_vs_mean_poc
"""
import json
...
OUT_DIR = Path(__file__).resolve().parents[1] / "outputs" / "optimization" / "median_vs_mean_poc"

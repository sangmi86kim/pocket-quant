...
[출력] app/lab/outputs/textbook_signal_xray/ 에 png 3장 + md 리포트.
실행: .venv/Scripts/python.exe -m app.lab.textbook_signal_xray
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "outputs", "textbook_signal_xray")

"""GP(Gaussian Process) 단일목적 엔진 — sampler 한 줄만 다르고 평가 경로는 single_objective.engine과 공유.
...
def run_study(trials, seed=None, storage=None, study_name="gp_single_obj",
              ...
              patience=None, min_delta_pct=None, warmstart=None):
    """GP 단일목적 탐색. single_objective.engine에 위임."""

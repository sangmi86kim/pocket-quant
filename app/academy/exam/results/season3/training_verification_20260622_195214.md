...
![수렴](graph/training_curves_20260622_195214_nsga_convergence.png)
...
![HV](graph/training_curves_20260622_195214_nsga_hv.png)

- best-so-far가 극단 1점만 본다면, HV는 **파레토 프론트 전체 부피**라 프론트가 촘촘·넓어지는
  것까지 잡는다. 빨강(이동평균)이 우상향 후 평탄 = 진짜 수렴. 조기종료도 이 HV로 판정한다.

![파레토](graph/training_curves_20260622_195214_nsga_front.png)

## 2. 단일목적·GP 수렴 (CMA-ES·GP)

![단일목적 수렴](graph/training_curves_20260622_195214_single_convergence.png)

CMA-ES·GP도 storage 보존 후 학습이라 수렴곡선 확인 가능.

## 3. 3교실 선발 분포

![선발](graph/training_curves_20260622_195214_selection.png)

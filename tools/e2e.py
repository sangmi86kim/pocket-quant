...
STAGES = [
    ...
    ("gate: academy synth",
     [sys.executable, "-m", "app.lab.diagnostics.check_academy_synth"], 60),
    ...
    ("diagnostic: signals",
     [sys.executable, "-m", "app.lab.diagnostics.check_signals"], 120),
    ("diagnostic: dca",
     [sys.executable, "-m", "app.lab.diagnostics.check_dca"], 900),

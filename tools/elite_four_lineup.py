...
산출: tools/outputs/elite_four_lineup.md (+ .json)
...
from tests.elite_four import DATA_END, HOLDOUT_START, ROUNDS, TICKER, _loaded_window

SEED_KRW = 1_000_000
TOP10_JSON = _ROOT / "tools" / "outputs" / "top10_champions.json"
OUT_MD = _ROOT / "tools" / "outputs" / "elite_four_lineup.md"

...
산출: tools/outputs/battle_frontier_total.md (+ .json)
실행: python tools/battle_frontier_total.py
"""
...
IN_JSON = _ROOT / "tools" / "outputs" / "battle_frontier_lineup.json"
OUT_MD = _ROOT / "tools" / "outputs" / "battle_frontier_total.md"

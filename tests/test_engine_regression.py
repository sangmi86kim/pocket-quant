...
쓰므로 오프라인에서도 돈다.
  ...
  자산과 훈련 자산 일치). 챔피언 REV_BB → VOL+REV_RSI+REV_BB로 교체됨.
...
# ── 골든 넘버 (2026-06-11 QQQ 통일 후 실측) ───────────────────────
GOLDEN_FITNESS = {
    "VOL+REV_RSI+REV_BB": 40.56560780396907,             # 현 챔피언
    "REV_RSI+REV_BB": 38.60746836892416,                 # 3위
    "DD+VOL+MA+MOM+REV_RSI+REV_BB": 28.315945136830905,  # 전 유전자 합체
}
...
GOLDEN_CHAMPION_SCORE_VS_DCA_AVG = 0.1763801793373233

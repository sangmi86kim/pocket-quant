...
GOLDEN_FITNESS = {
    "VOL+REV_RSI+REV_BB": 42.605755358252,               # 현 챔피언
    "VOL+REV_RSI": 41.58422947505787,                    # 2위
    "DD+VOL+MA+MOM+REV_RSI+REV_BB": 30.02795958546863,   # 전 유전자 합체
}

# 챔피언의 닷컴 체육관 raw 지표 (총수익 / 최대낙폭 / 샤프 / 일평균 턴오버)
GOLDEN_CHAMPION = "VOL+REV_RSI+REV_BB"
GOLDEN_CHAMPION_DOTCOM = {
    "total_return": 0.11790678477133953,
    "max_drawdown": -0.12875973622597214,
    "sharpe": 0.3432480588953737,
...
GOLDEN_DCA = {
    ...
    "2009-10 회복장 체육관": {
        "total_return": 0.28893556776636964,
        "max_drawdown": -0.10633805811292385,
        "sharpe": 1.3657271966168378,
    },
    "2020 코로나 급락 체육관": {
        "total_return": 0.15694383858905425,
        "max_drawdown": -0.06585305960117116,
        "sharpe": 1.9869519779916751,
    },
}

GOLDEN_CHAMPION_SCORE_VS_DCA_AVG = 0.15391728661313583

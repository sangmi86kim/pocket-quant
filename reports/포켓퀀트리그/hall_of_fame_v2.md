...
> 4아레나(체육관·빅토리 로드 (OOS)·평행세계·사천왕)에서 top30 전원을 같은 기준으로 재평가했다.
...
- **빅토리 로드 (OOS) 11년 후보 1위 1,252만** — 어플삭제단 300명 중앙값(1,205만)을 이김
...
- **v2 재리그(top30 분포)**: 각 교실 30명 + 어플삭제단 300명 + 기준선 3종을 같은 **4아레나**에서 비교.
  ...
  - 빅토리 로드 (OOS) 11년 중앙값: NSGA 1,242만 · CMA-ES 1,222만 · TPE 1,212만 · 어플삭제단 1,205만 · GP 1,137만.
...
- **정정**: GP는 시험장 점수는 높지만 30명이 한 답 복붙(std 0)이고 빅토리 로드 (OOS)·사천왕 중앙값이 어플삭제단보다 낮아 벤치.
...
![빅토리 로드 (OOS) 11년 합산 boxplot](graph/v2/season_v2_top30_league_oos_boxplot.svg)

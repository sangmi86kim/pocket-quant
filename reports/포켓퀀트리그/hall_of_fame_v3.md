...
> 재학습한 뒤, OOS 11년 → 사천왕 hold-out 7라운드 본경기를 쳤다.
...
- **종합 18라운드 median**: **117.7만원** (100만원 시드) — 그룹 1위(NSGA-1차 117.3만)
  중에서도 개인 1위
- **OOS 11년 median**: 109.6만 · **사천왕 7라운드 median**: 121.7만
...
### 종합 median (18라운드 = OOS 11년 + 사천왕 7라운드, 100만원 시드)

| 그룹 | n | overall median | OOS median | holdout median |
|---|---:|---:|---:|---:|
...
> 라운드별 전체 표·국면 비율은 [`season3_league.md`](../../app/lab/reports/season3_league/season3_league.md) 참조 (lab 산출물 — 매 실행마다 덮어쓰임, 영구 기록은 본 페이지가 보존).
...
구간은 'OOS 끝자락 참고 시험지'로 본다. **다음 최종 시험지는 지금부터 쌓이는 미래 데이터**.
...
- 리그 결과(lab 산출물): [`season3_league.md`](../../app/lab/reports/season3_league/season3_league.md) · [`season3_league.json`](../../app/lab/reports/season3_league/season3_league.json)

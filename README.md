...
- **No.000 트레이더** — **포켓퀀트 협회장**. 퀀트 입문 초보인데 얼떨결에 협회를
  떠맡아 고생 중인 운전대 담당(연구 방향을 정하는 인간 디렉터). 오박사처럼 판정·계산은
  안 하지만, 박사가 데이터로 성급히 단정하면 *"그게 맞냐, 쪼개서 다시 봐"* 로 의심한다 —
...
- 🗓️ **시즌 4 (예정)** — ① **시장 판독기**(regime detector, 70/30 오버레이 — MA200 후행 라벨러를 크로스에셋·위험선호 즉시 스캔으로 재설계, #1918 대기) ② **배틀 프론티어 개편** — 합성 평행세계가 외부신호를 꺼버려(NaN 기권) 크로스에셋 챔피언(예: NSGA-t5938의 US10Y·QQQ_SPY·QQQ_DIA)을 평가 못 하는 '장님' 문제. 둘 다 2026-06-18 시즌4 연기

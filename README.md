...
| 빅토리 로드 (OOS) | 처음 보는 연도 시험 (Out Of Samples 처음 보는 미래 데이터로 출전)                                |
...
블록 부트스트랩 합성장에서 훈련 → 실QQQ 6체육관 졸업시험 → **4아레나**(체육관 · 빅토리 로드 (OOS) 11년 ·
...
| 🎫 빅토리 로드 (OOS) 11년 (핵심 잣대) | 안 본 평시 11년 실QQQ 누적 | ✅ **NSGA 중앙값이 어플삭제단(공정 B&H) 중앙값 이김** |
...
│  ├─ league/              # 🏆 리그 — victory_road(챔피언로드 ①) · battle_frontier(②) · elite_four(③) · operations/(npcs·regime_picks)
